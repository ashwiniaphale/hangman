...
<h1>HANGMAN!</h1>
  ...
  <div class="navbar">
    <a href="https://codd.cs.gsu.edu/~aaphale1/Hangman/input.php">Home</a>
    <a href="https://codd.cs.gsu.edu/~aaphale1/Hangman/level1.php">Level 1</a>
    <a href="https://codd.cs.gsu.edu/~aaphale1/Hangman/level2.php">Level 2</a>
    <a href="https://codd.cs.gsu.edu/~aaphale1/Hangman/level3.php">Level 3</a>
    <a href="https://codd.cs.gsu.edu/~aaphale1/Hangman/level4.php">Level 4</a>
  </div>

<div class="login">
<form action="https://codd.cs.gsu.edu/~aaphale/Hangman/level1.php" method="post">
